...
export default function HomePage() {
  ...
  return (
      ...
      >
        <div id="landing" className="h-[600px] my-40 relative xl:px-20 lg:px-5 md:px-5 px-2 max-w-[2000px] w-screen">
          ...
          <p className="absolute bottom-0 right-20 -rotate-45 text-xl font-body text-t2 p-5">Compiled in 236ms (519 modules)<br/>Compiled in 236ms (519 modules)<br/>Compiled in 236ms (519 modules)<br/></p>
        </div>
